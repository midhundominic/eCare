...
import { getPendingTests, uploadTestResult } from '../../../services/prescriptionServices';
...
const LaboratoryPending = () => {
  ...
  const handleUpload = async () => {
    ...
    console.log("user id",userId);
      ...
      toast.error(error.response?.data?.message || 'Error uploading test result');
    } finally {
      setLoading(false);
    }
  };
        ...
        <DialogContent>
          <Box className={styles.uploadContent}>
            <Box className={styles.patientInfo}>
              ...
              <Typography><strong>Name:</strong> {selectedTest?.patientName}</Typography>
              <Typography><strong>Test:</strong> {selectedTest?.testName}</Typography>
              <Typography><strong>Email:</strong> {selectedTest?.patientEmail}</Typography>
              <Typography><strong>Phone:</strong> {selectedTest?.patientPhone}</Typography>
              <Typography><strong>Address:</strong> {selectedTest?.patientAddress}</Typography>
            </Box>
